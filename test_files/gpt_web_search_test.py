#!/usr/bin/env python3
"""
Test runner for chatgpt_search.py — run multiple key/value queries and view structured results.
"""
...
def main():
    ...
    out_path = f"chatgpt_search_results_{datetime.utcnow().strftime('%Y%m%dT%H%M%SZ')}_{uuid.uuid4().hex[:8]}.json"
