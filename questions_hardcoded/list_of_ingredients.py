"""
List of Ingredients and Allergen Labelling Checklist Questions Extractor for CFIA Compliance.

This module extracts checklist questions from the CFIA Food Labelling
Requirements Checklist - List of Ingredients and Allergen Labelling section using:
...
Usage:
    python checklist_questions/list_of_ingredients.py

Output:
    checklist_questions/list_of_ingredients_questions.json
"""
...
OUTPUT_FILE = OUTPUT_DIR / "list_of_ingredients.json"


def extract_list_of_ingredients_questions(
    api_key: Optional[str] = None,
    save_to_file: bool = True
) -> Dict[str, Any]:
    """
    Extract List of Ingredients and Allergen Labelling checklist questions from CFIA website.
    ...
    """
    print("=" * 60)
    print("CFIA List of Ingredients Checklist Questions Extractor")
    print("=" * 60)
    print(f"Source: {CFIA_REQUIREMENTS_CHECKLIST_URL}")
    print(f"Section: List of Ingredients and Allergen Labelling")
    print("-" * 60)
    
    # Step 1: Scrape the raw section text
    print("Step 1: Scraping raw section text...")
    raw_text = scrape_section("List of ingredients and allergen labelling", "Name and principal place of business")
    ...
    prompt = f"""
Below is the raw text scraped from the CFIA Food Labelling Requirements Checklist - List of Ingredients and Allergen Labelling section.
...
"""
    ...
    output = {
        "metadata": {
            ...
            "section": "List of Ingredients and Allergen Labelling",
...
def get_questions() -> List[Dict[str, Any]]:
    """
    Get List of Ingredients questions - loads from JSON if available, otherwise extracts fresh.
    ...
    result = extract_list_of_ingredients_questions(save_to_file=True)
...
if __name__ == "__main__":
    ...
    result = extract_list_of_ingredients_questions()
